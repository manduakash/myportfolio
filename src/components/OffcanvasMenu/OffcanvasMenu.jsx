...
const OffcanvasMenu = (props) => {
    ...
    // destructuring props
    const { darkMode, darkModeStyle, darkModeEnable } = props
    ...
    return (
        <div style={darkModeStyle} className='offcanvas offcanvas-start' tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div className="offcanvas-body menu">
                <ul>
                    <li className="menu-item"><a data-scroll-to onClick={()=>{canvasClose()}} href={`${window.innerWidth<600?'#landing-page-section':'#home-section'}`}>Intro</a></li>
                    ...
                    <li className="menu-item"><a data-scroll-to onClick={()=>{canvasClose()}} href="#interest-section">Interests</a></li>
                    <li className="menu-item"><a data-scroll-to onClick={()=>{canvasClose()}} href="#contact-section">Contact</a></li>
                    <li className="menu-item"><a data-scroll-to onClick={()=>{ActivateDarkMode()}} href={`${window.innerWidth<600?'#landing-page-section':'#home-section'}`}>Dark Mode: {darkMode?(<span className="text-danger">on</span>):(<span className="text-danger">off</span>)}</a></li>
